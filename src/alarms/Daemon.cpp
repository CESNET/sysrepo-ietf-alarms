...
void Daemon::updateAlarmListStats(libyang::DataNode& edit, size_t alarmCount, const std::chrono::time_point<std::chrono::system_clock>& lastChanged)
{
    ...
    edit.newPath("/ietf-alarms:alarms/alarm-list/last-changed", utils::yangTimeFormat(lastChanged).c_str());
}

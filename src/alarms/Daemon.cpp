...
sysrepo::ErrorCode Daemon::submitAlarm(const libyang::DataNode& input)
{
    ...
    const auto alarmNodePath = "/ietf-alarms:alarms/alarm-list/alarm[alarm-type-id='"s + alarmKey.alarmTypeId + "'][alarm-type-qualifier='" + alarmKey.alarmTypeQualifier + "'][resource=\"" + alarmKey.resource + "\"]";

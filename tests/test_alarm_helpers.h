...
#define ALARM_SUMMARY_IMPL(SEVERITY, CLEARED, NOT_CLEARED) \
    {"/summary/alarm-summary[severity='" SEVERITY "']", ""}, \
    {"/summary/alarm-summary[severity='" SEVERITY "']/severity", SEVERITY}, \
    {"/summary/alarm-summary[severity='" SEVERITY "']/cleared", std::to_string(CLEARED)}, \
    {"/summary/alarm-summary[severity='" SEVERITY "']/not-cleared", std::to_string(NOT_CLEARED)}, \
    {"/summary/alarm-summary[severity='" SEVERITY "']/total", std::to_string(CLEARED + NOT_CLEARED)}

#define CLEARED(N) N
#define NOTCLEARED(N) N
#define CRITICAL(CLEARED, NOT_CLEARED) ALARM_SUMMARY_IMPL("critical", CLEARED, NOT_CLEARED)
#define WARNING(CLEARED, NOT_CLEARED) ALARM_SUMMARY_IMPL("warning", CLEARED, NOT_CLEARED)
#define MAJOR(CLEARED, NOT_CLEARED) ALARM_SUMMARY_IMPL("major", CLEARED, NOT_CLEARED)
#define MINOR(CLEARED, NOT_CLEARED) ALARM_SUMMARY_IMPL("minor", CLEARED, NOT_CLEARED)
#define INDETERMINATE(CLEARED, NOT_CLEARED) ALARM_SUMMARY_IMPL("indeterminate", CLEARED, NOT_CLEARED)

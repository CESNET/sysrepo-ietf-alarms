...
TEST_CASE("Basic alarm publishing and updating")
{
    ...
    {
        CLI_UPSERT_ALARM(time, cli1Sess, "alarms-test:alarm-1", "high", "edfa", "warning", "Hey, I'm overheating.");
    ...
    {
        CLI_UPSERT_ALARM(time1, cli1Sess, "alarms-test:alarm-1", "high", "edfa", "warning", "Hey, I'm overheating.");
        CLI_UPSERT_ALARM(time2, cli2Sess, "alarms-test:alarm-2-1", "", "psu-1", "major", "More juice pls.");
    ...
    {
        CLI_UPSERT_ALARM(time, cli1Sess, "alarms-test:alarm-2-1", "disconnected", "psu-1", "major", ALARM_TEXT_NONE);
        REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                    {"/alarm-list", ""},
                    ...
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']/time-created", EXPECT_TIME_INTERVAL(time)},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']/last-raised", EXPECT_TIME_INTERVAL(time)},
                    {"/control", ""},
                });
        ...
        {
            CLI_UPSERT_ALARM(time1, cli1Sess, "alarms-test:alarm-2-1", "disconnected", "psu-1", "cleared", ALARM_TEXT_NONE);
            REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                        {"/alarm-list", ""},
                        {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']", ""},
                        {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']/alarm-type-id", "alarms-test:alarm-2-1"},
            ...
            {
                CLI_UPSERT_ALARM(time2, cli1Sess, "alarms-test:alarm-2-1", "disconnected", "psu-1", "major", ALARM_TEXT_NONE);
                REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                            {"/alarm-list", ""},
                            {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']", ""},
                            {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']/alarm-type-id", "alarms-test:alarm-2-1"},
        ...
        {
            CLI_UPSERT_ALARM(time3, cli1Sess, "alarms-test:alarm-1", "high", "edfa", "cleared", ALARM_TEXT_NONE);
            REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                        {"/alarm-list", ""},
                        {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']", ""},
                        {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='disconnected']/alarm-type-id", "alarms-test:alarm-2-1"},
    ...
    {
        CLI_UPSERT_ALARM(time1, cli1Sess, "alarms-test:alarm-2-1", "qual", "psu-1", "indeterminate", ALARM_TEXT_NONE);
        ...
        CLI_UPSERT_ALARM(time2, cli1Sess, "alarms-test:alarm-2-1", "qual", "psu-1", "minor", "No worries.");
        REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                    {"/alarm-list", ""},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='qual']", ""},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='qual']/alarm-type-id", "alarms-test:alarm-2-1"},
        ...
        CLI_UPSERT_ALARM(time3, cli1Sess, "alarms-test:alarm-2-1", "qual", "psu-1", "critical", ALARM_TEXT_NONE);
        REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                    {"/alarm-list", ""},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='qual']", ""},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='qual']/alarm-type-id", "alarms-test:alarm-2-1"},
        ...
        CLI_UPSERT_ALARM(time4, cli1Sess, "alarms-test:alarm-2-1", "qual", "psu-1", "cleared", ALARM_TEXT_NONE);
        REQUIRE(dataFromSysrepo(*userSess, "/ietf-alarms:alarms", sysrepo::Datastore::Operational) == std::map<std::string, std::variant<std::string, AnyTimeBetween>>{
                    {"/alarm-list", ""},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='qual']", ""},
                    {"/alarm-list/alarm[resource='psu-1'][alarm-type-id='alarms-test:alarm-2-1'][alarm-type-qualifier='qual']/alarm-type-id", "alarms-test:alarm-2-1"},

    ...
    SECTION("Another client creates an alarm")
    {
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    ALARM_SUMMARY(
                            CRITICAL(Summary({.cleared = 0, .notCleared = 0})),
                            WARNING(Summary({.cleared = 0, .notCleared = 1})),
                            MAJOR(Summary({.cleared = 0, .notCleared = 1})),
                            MINOR(Summary({.cleared = 0, .notCleared = 0})),
                            INDETERMINATE(Summary({.cleared = 0, .notCleared = 0}))),
                });
    ...
    SECTION("Client disconnects, then connects again and clears the alarm")
    {
        ...
        SECTION("Clears the alarm that was set before and then sets it back")
        {
            ...
            REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                        ...
                        ALARM_SUMMARY(
                                CRITICAL(Summary({.cleared = 0, .notCleared = 0})),
                                WARNING(Summary({.cleared = 1, .notCleared = 0})),
                                MAJOR(Summary({.cleared = 0, .notCleared = 0})),
                                MINOR(Summary({.cleared = 0, .notCleared = 0})),
                                INDETERMINATE(Summary({.cleared = 0, .notCleared = 0}))),
                    });
    ...
    SECTION("Updating state")
    {
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    ALARM_SUMMARY(
                            ...
                            MAJOR(Summary({.cleared = 0, .notCleared = 0})),
                            MINOR(Summary({.cleared = 0, .notCleared = 0})),
                            INDETERMINATE(Summary({.cleared = 0, .notCleared = 1}))),
                });
        REQUIRE(checkAlarmListLastChanged(actualDataFromSysrepo, "edfa", "alarms-test:alarm-1", "high"));
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    ALARM_SUMMARY(
                            ...
                            WARNING(Summary({.cleared = 0, .notCleared = 0})),
                            MAJOR(Summary({.cleared = 0, .notCleared = 0})),
                            MINOR(Summary({.cleared = 0, .notCleared = 1})),
                            INDETERMINATE(Summary({.cleared = 0, .notCleared = 0}))),
                });
        REQUIRE(checkAlarmListLastChanged(actualDataFromSysrepo, "edfa", "alarms-test:alarm-1", "high"));
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    ALARM_SUMMARY(
                            ...
                            WARNING(Summary({.cleared = 0, .notCleared = 0})),
                            MAJOR(Summary({.cleared = 0, .notCleared = 0})),
                            MINOR(Summary({.cleared = 1, .notCleared = 0})),
                            INDETERMINATE(Summary({.cleared = 0, .notCleared = 0}))),
                });
        REQUIRE(checkAlarmListLastChanged(actualDataFromSysrepo, "edfa", "alarms-test:alarm-1", "high"));
    ...
    SECTION("Properly escaped resource string")
    {
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    ALARM_SUMMARY(
                            ...
                            WARNING(Summary({.cleared = 0, .notCleared = 1})),
                            MAJOR(Summary({.cleared = 0, .notCleared = 0})),
                            MINOR(Summary({.cleared = 0, .notCleared = 2})),
                            INDETERMINATE(Summary({.cleared = 0, .notCleared = 0}))),
                });

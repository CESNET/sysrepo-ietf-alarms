...
TEST_CASE("Basic alarm publishing and updating")
{
    ...
    SECTION("Updating state")
    {
        ...
        actualDataFromSysrepo = dataFromSysrepo(*userSess, "/ietf-alarms:alarms/alarm-list/alarm[resource='edfa'][alarm-type-id='alarms-test:alarm-1'][alarm-type-qualifier='high']", sysrepo::Datastore::Operational);
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    {"/alarm-type-id", "alarms-test:alarm-1"},
                    {"/alarm-type-qualifier", "high"},
                    {"/resource", "edfa"},
                    {"/is-cleared", "false"},
                    {"/perceived-severity", "critical"},
                    {"/alarm-text", "Hey, I'm overheating."},
                    {"/time-created", origTime},
                    {"/last-raised", changedTimes[3]},
                    {"/last-changed", changedTimes[4]},
                    ALARM_STATUS_CHANGE_NOPREFIX(1, "edfa", "alarms-test:alarm-1", "high", changedTimes[3], "major", "Hey, I'm overheating."),
                    ALARM_STATUS_CHANGE_NOPREFIX(2, "edfa", "alarms-test:alarm-1", "high", changedTimes[4], "critical", "Hey, I'm overheating."),
                });
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    {"/time-created", origTime},
                    {"/last-raised", changedTimes[3]},
                    {"/last-changed", changedTimes[5]},
                    ALARM_STATUS_CHANGE_NOPREFIX(1, "edfa", "alarms-test:alarm-1", "high", changedTimes[4], "critical", "Hey, I'm overheating."),
                    ALARM_STATUS_CHANGE_NOPREFIX(2, "edfa", "alarms-test:alarm-1", "high", changedTimes[5], "warning", "Hey, I'm overheating."),
                });
        ...
        REQUIRE(actualDataFromSysrepo == PropsWithTimeTest{
                    ...
                    {"/is-cleared", "false"},
                    {"/perceived-severity", "warning"},
                    {"/alarm-text", "text change"},
                    {"/time-created", origTime},
                    {"/last-raised", changedTimes[3]},
                    {"/last-changed", changedTimes[6]},
                    ALARM_STATUS_CHANGE_NOPREFIX(1, "edfa", "alarms-test:alarm-1", "high", changedTimes[4], "critical", "Hey, I'm overheating."),
                    ALARM_STATUS_CHANGE_NOPREFIX(2, "edfa", "alarms-test:alarm-1", "high", changedTimes[5], "warning", "Hey, I'm overheating."),
                    ALARM_STATUS_CHANGE_NOPREFIX(3, "edfa", "alarms-test:alarm-1", "high", changedTimes[6], "warning", "text change"),
                });
    }
